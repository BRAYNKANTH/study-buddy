  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24 lg:pb-6">
        ...
        {activeTab === 'enroll' && <EnrollmentForm parent={user} onSuccess={handleEnrollmentSuccess} />}
        {activeTab === 'timetable' && selectedStudent && <Timetable student={selectedStudent} />}
        {activeTab === 'materials' && selectedStudent && <ViewMaterials student={selectedStudent} />}
        {activeTab === 'attendance' && selectedStudent && <AttendanceTracker student={selectedStudent} />}
        {activeTab === 'reportcard' && selectedStudent && <ReportCard student={selectedStudent} />}
        {activeTab === 'chat' && <ParentChatWithPasscode parent={user} />}
        {activeTab === 'payments' && <MonthlyPaymentSystem parent={user} />}
        {activeTab === 'profile' && selectedStudent && <StudentProfile student={selectedStudent} parent={user} />}
